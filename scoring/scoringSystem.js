...
export let AnalyzeScores = (userDomain,userContent)=>{
    ...
    dayWiseScores.map((day,index)=>{
        day.focusScore=day.focusScore/maxDayWiseScores[index].focusScore*100;
        day.moodScore=day.moodScore/maxDayWiseScores[index].moodScore*100;
        day.creativityScore=day.creativityScore/maxDayWiseScores[index].creativityScore*100;
        day.productivityScore=day.productivityScore/maxDayWiseScores[index].productivityScore*100;
        day.sentimentScore=day.sentimentScore/maxDayWiseScores[index].sentimentScore*100;
        day.contentScore=day.contentScore/maxDayWiseScores[index].contentScore*100;
        day.totalScore=day.totalScore/maxDayWiseScores[index].totalScore*100;
        day.wellbeingScore=day.wellbeingScore/maxDayWiseScores[index].wellbeingScore*100
    })
    return {overallScores:parameters,dayWiseScores:dayWiseScores, categoryData:categoryData , visitedDomains:visitedDomains , allTime:allTime};
}
